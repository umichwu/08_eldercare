...
COMMENT ON TABLE public.medications IS '藥物主表';
...
COMMENT ON TABLE public.medication_reminders IS '用藥排程表';
...
BEGIN
    RAISE NOTICE '============================================================================';
    RAISE NOTICE '✅ ElderCare Companion v3.0 完整資料庫 Schema 建置完成！';
    RAISE NOTICE '============================================================================';
    RAISE NOTICE '';
    RAISE NOTICE '已建立的核心系統:';
    RAISE NOTICE '  1. 使用者認證系統 (Supabase Auth + OAuth)';
    RAISE NOTICE '  2. 用藥提醒系統 (FCM 推送 + Cron 排程)';
    ...
    RAISE NOTICE '';
    RAISE NOTICE '下一步:';
    RAISE NOTICE '  1. 啟動後端服務 (npm run dev)';
    RAISE NOTICE '  2. 測試 API 端點';
    RAISE NOTICE '  3. 開發前端介面';
    RAISE NOTICE '============================================================================';
END $$;

COMMENT ON SCHEMA public IS 'ElderCare Companion v3.0 - 完整系統 Schema';
