...
const translations = {
  'zh-TW': {
    ...
    'quickAction.medication': '💊 用藥管理',
    'quickAction.dailyReminders': '📅 生活提醒',
  ...
  'en-US': {
    ...
    'quickAction.dailyReminders': '📅 Daily Reminders',
  ...
  'ja-JP': {
    ...
    'quickAction.medication': '💊 服薬管理',
    'quickAction.dailyReminders': '📅 生活リマインダー',
  ...
  'ko-KR': {
    ...
    'quickAction.medication': '💊 복약 관리',
    'quickAction.dailyReminders': '📅 생활 리마인더',
